...
go test -tags integration -v -p 1 -short \
  -run 'TestConn_SimpleAndExtended|TestRolePrivileges|TestRLS_TenantIsolation|TestPG_IdempotencyLedger|TestPG_CostLedger|TestPGOutbox_DurableDeliveryAndCrashSafety|TestPGOutbox_DeadLetterAfterMaxAttempts|TestPGOutbox_RedriveReplaysParkedJob|TestApply_OrderedAndIdempotent|TestPending_ReportsUnapplied|TestApply_NoTransactionEscapeHatch|TestE2E_FullStack|TestDashRLSZeroRows|TestDashLoginMFAAndSecurity|TestDashFeatureWiring|TestDashApprovalGateWiring|TestKeysImportSealAndRLS|TestPoisonImportRowIsolation|TestImportLoad50k|TestProvidersLifecycleAndRLS|TestRotationLeaseNoOverLease|TestRotationEngineE2E|TestConfigLifecycleAndRLS|TestConcurrentPublishConflict|TestPublishCrashFaultPointInvariant|TestPGRestartPoolRecovers|TestHealthTimelineFoldAndNoData|TestTelemetryFoldRefoldIdentical|TestTelemetryPartitionMaintainer|TestTelemetryReconcileKeyBudgets|TestTelemetryLeaderElection|TestFold1M|TestApprovalsExactlyOnce|TestApprovalsNegativeDecisions|TestCostGroupBysMatchLedgers|TestCostRLSIsolation|TestAlertsFireDedupeResolve|TestAlertsTestSendSSRFBlocked|TestAlertsRLSIsolation|TestQueuesReplayIdempotent|TestQueuesFilteredReplay|TestQueuesTenantIsolation|TestQueueStatsFoldAndList|TestWorkersDrainConverges|TestWorkersLostDetection|TestSSESoakLite|TestSelfMonitorRLS|TestPollerDerivesEvents|TestOverviewSnapshotThenDelta|TestOverviewAggregatorFailover|TestSessionsRevokeAllForUser|TestProvisioningTenantAndInvite|TestProvisioningInviteSingleUseRace|TestDashRequireMFAKnob|TestDashVerifyStepUp' \
  ./internal/pg/ ./internal/pgstore/ ./internal/pgoutbox/ ./internal/pgmigrate/ ./internal/e2e/ ./internal/dash/e2e/ ./internal/dash/keys/ ./internal/dash/providers/ ./internal/dash/rotation/ ./internal/dash/configver/ ./internal/dash/health/ ./internal/dash/telemetry/ ./internal/dash/approvals/ ./internal/dash/cost/ ./internal/dash/alerts/ ./internal/dash/queues/ ./internal/dash/workers/ ./internal/dash/realtime/ ./internal/dash/overview/ ./internal/dash/security/ ./internal/dash/provisioning/
