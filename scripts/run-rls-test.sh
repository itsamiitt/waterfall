...
go test -tags integration -v -p 1 \
  -run 'TestConn_SimpleAndExtended|TestRolePrivileges|TestRLS_TenantIsolation|TestPG_IdempotencyLedger|TestPG_CostLedger|TestPGOutbox_DurableDeliveryAndCrashSafety|TestPGOutbox_DeadLetterAfterMaxAttempts|TestPGOutbox_RedriveReplaysParkedJob|TestApply_OrderedAndIdempotent|TestPending_ReportsUnapplied|TestE2E_FullStack|TestDashRLSZeroRows|TestDashLoginMFAAndSecurity|TestDashFeatureWiring|TestKeysImportSealAndRLS|TestProvidersLifecycleAndRLS|TestRotationLeaseNoOverLease|TestRotationEngineE2E|TestConfigLifecycleAndRLS|TestConcurrentPublishConflict' \
  ./internal/pg/ ./internal/pgstore/ ./internal/pgoutbox/ ./internal/pgmigrate/ ./internal/e2e/ ./internal/dash/e2e/ ./internal/dash/keys/ ./internal/dash/providers/ ./internal/dash/rotation/ ./internal/dash/configver/
